...
# Implementation by André Cardoso

## Spring Boot
The project is based on Java using the Spring Boot Framework.

The serve run at port 9091 and it will contain an embeded in-memory h2database for pratical porpuse.

Follow information about h2database can be found here:

  [1. Baeldung Article](https://www.baeldung.com/spring-boot-h2-database) <br>
  [2. Stack Abuse article](https://stackabuse.com/integrating-h2-database-with-spring-boot/)


To access the h2database console use
    
    http://localhost:9091/h2-console

The file `car-polling.postman_collection.json` can be open by [Postman](https://www.postman.com/) for uses examples.
